...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': { roles: ['owner', 'admin', 'manager'], key: 'order_123', tenantPath: [], userPath: [] },
  'PaymentReceived.create': { roles: ['owner', 'admin', 'manager'], key: 'payment_123', tenantPath: [], userPath: [] },
  'InventoryUpdated.update': { roles: ['owner', 'admin'], key: 'inventory_123', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'admin', 'manager', 'employee', 'customer'];
