  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Store, your reliable partner for seamless store and admin panel management. We simplify your business operations for better efficiency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1441986300917-64674bd600d8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdG9yZXxlbnwwfHx8fDE2OTY3MzI5NjN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mercantile?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Clark Street Mercantile`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Store, your reliable partner for seamless store and admin panel management. We simplify your business operations for better efficiency.`}
            </Text>
            <Box
